...
class Books_Data:
    ...
    def library(self,converse,tag):
        ...
        if(tag=='books_name'):
            ...
            output='Number of copies of each book:\n'
            ...
            if(books_by_name is None):
                if(books_by_author is None):
                    ...
                    output+='Author Name : Number of copies\n'
                    for x in books_by_name:
                        output+=x['AuthorName']+':'+str(x['CopiesNumber'])+'\n'
                    return output
            elif(books_by_author is None):
                output+='Book Name : Number of copies\n'
                for x in books_by_name:
                    output+=x['BookName']+':'+str(int(x['CopiesNumber']))+'\n'
                return output
            else:
                output+='Book Name : Number of copies\n'
                for x in books_by_name:
